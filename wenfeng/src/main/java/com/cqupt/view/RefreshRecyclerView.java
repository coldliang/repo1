 ...
 * 使用：com.campussay.component.widget.RefreshRecyclerView
 */
...
public class RefreshRecyclerView extends RecyclerView {
    private final String TAG = RefreshRecyclerView.class.getSimpleName();
    ...
    /**
     * ItemCount超过8后，加载 加载更多 布局，否则加载 没有更多 布局
     */
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (null != mListener && mIsFooterEnable && !mIsLoadingMore &&
                    ...
                    if (lastVisiblePosition + 1 == mAutoLoadAdapter.getItemCount()) {
                        ...
                        if (getAdapter().getItemCount() < maxItemCount) {
    ...
    public class AutoLoadAdapter extends Adapter<ViewHolder> {
        ...
        private FooterViewHolder footerViewHolderMore;
        private FooterViewHolder footerViewHolderNoMore;
        ...
        public int getItemViewType(int position) {
            ...
            if (footerPosition == position && mIsFooterEnable) {
                ...
                if(mIsHeaderEnable && mHeaderResId > 0){
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == TYPE_HEADER) {
                ...
                if(footerViewHolderMore == null){
                    footerViewHolderMore = new FooterViewHolder(LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.reflashrecycler_foot, parent, false));
                }
                if(footerViewHolderNoMore == null){
                    footerViewHolderNoMore = new FooterViewHolder(LayoutInflater.from(parent.getContext())
                            .inflate(R.layout.reflashrecycler_foot_nomore, parent,
                                    false));
                }
                if (getItemCount() > maxItemCount) {
                    return footerViewHolderMore;
                } else {
                    return footerViewHolderNoMore;
                }
            } else { // type normal
